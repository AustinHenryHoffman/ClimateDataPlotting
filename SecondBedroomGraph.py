...
query = f"SELECT date, time, temperature, humidity FROM house_climate_data WHERE location = 'Second Bedroom' and date='{today}'"
...
# Set the title
plt.title("Temperature and Humidity in Second Bedroom")
...
image = Image.open(f'./images/SecondBedroom_{datetime}.png')
...
#raw_file_path = f'./images/SecondBedroom_{datetime}_128x128.raw'
