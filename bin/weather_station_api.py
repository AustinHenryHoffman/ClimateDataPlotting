...
def send_masterbedroom():
    ...
    subprocess.run(['/home/Dr.Tautology/anaconda3/bin/python', '/home/Dr.Tautology/ClimateDataPlotting/ClimateDataPlotting/graph_climate.py', 'masterbedroom'])
...
def send_livingroom():
    # Replace './images' with the actual directory path where your images are located
    images_dir = '/home/Dr.Tautology/ClimateDataPlotting/ClimateDataPlotting/images/'
    subprocess.run(['/home/Dr.Tautology/anaconda3/bin/python', '/home/Dr.Tautology/ClimateDataPlotting/ClimateDataPlotting/graph_climate.py', 'livingroom'])
    # Get the list of files in the directory
    image_files = os.listdir(images_dir)
    # Filter the files to only include those starting with "Master_Bedroom"
...
def send_secondbedroom():
    # Replace './images' with the actual directory path where your images are located
    images_dir = '/home/Dr.Tautology/ClimateDataPlotting/ClimateDataPlotting/images/'
    subprocess.run(['/home/Dr.Tautology/anaconda3/bin/python', '/home/Dr.Tautology/ClimateDataPlotting/ClimateDataPlotting/graph_climate.py', 'secondbedroom'])
    # Get the list of files in the directory
    image_files = os.listdir(images_dir)
    # Filter the files to only include those starting with "Master_Bedroom"
